package VtorKolokvium.Zadaca23;
...
//                .forEach(student -> {
//                    sumOfPointsByYear.putIfAbsent(student.getYearOfStudies(), 0.0);
//                    countByYear.putIfAbsent(student.getYearOfStudies(), 0);
//                    sumOfPointsByYear.computeIfPresent(student.getYearOfStudies(),
//                            (k, v) -> v + student.getSummaryPoints()
//                    );
//
